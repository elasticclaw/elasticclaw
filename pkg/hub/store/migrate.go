...
// Migrate creates and upgrades the hub schema. Moved verbatim from
// pkg/hub/db.go as part of the phase-2 store extraction; the schema and
// upgrade statements are unchanged.
