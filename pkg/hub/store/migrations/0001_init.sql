-- 0001_init: consolidated baseline schema for ElasticClaw's hub database.
-- This is the pre-versioning schema (all historical CREATE TABLE statements
-- with every ALTER TABLE column collapsed into the CREATE definitions).
