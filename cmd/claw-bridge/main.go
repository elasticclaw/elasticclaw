...
// installOpenClaw installs openclaw@2026.5.5 via npm.
func installOpenClaw() error {
	log.Printf("[bootstrap] installing openclaw@2026.5.5...")
	if err := runShell("sudo npm install -g openclaw@2026.5.5 --ignore-scripts"); err != nil {
