...
export function TicketDetailPanel({ ticket, filters, canViewCosts, onClose, onOpenRun }: { ticket: AnalyticsTicket | null; filters?: TaskRunAnalyticsFilters; canViewCosts: boolean; onClose: () => void; onOpenRun: (run: AnalyticsTicketRunSummary) => void }) {
