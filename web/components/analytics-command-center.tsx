...
const chartConfig = {
  ...
  humanInTheLoop: { label: "Human on the loop", color: "var(--chart-2)" },
  warning: { label: "Warning", color: "var(--chart-3)" },
  failed: { label: "Failed", color: "var(--chart-4)" },
  ticketDelivered: { label: "Delivered", color: "var(--chart-1)" },
  ticketInProgress: { label: "In progress", color: "var(--chart-3)" },
